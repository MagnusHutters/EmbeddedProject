...
entity runner_control_s_axi is
generic (
...
end entity runner_control_s_axi;
...
architecture behave of runner_control_s_axi is
    ...
    constant ADDR_INPUT_R_BASE : INTEGER := 16#2000#;
    constant ADDR_INPUT_R_HIGH : INTEGER := 16#3fff#;
    ...
    -- memory signals
    signal int_input_r_address0 : UNSIGNED(10 downto 0);
    ...
    signal int_input_r_address1 : UNSIGNED(10 downto 0);
    ...
    component runner_control_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component runner_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : runner_control_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1536,
     AWIDTH   => log2(1536))
...
-- ----------------------- Memory logic ------------------
    ...
    int_input_r_address1 <= raddr(12 downto 2) when ar_hs = '1' else waddr(12 downto 2);
...
entity runner_control_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity runner_control_s_axi_ram;

architecture behave of runner_control_s_axi_ram is
