...
entity runner_one_half_table_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of runner_one_half_table_rom is 
...
entity runner_one_half_table is
    generic (
...
architecture arch of runner_one_half_table is
    component runner_one_half_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    runner_one_half_table_rom_U :  component runner_one_half_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
