...
#(parameter
    ...
    input  wire [10:0]                   input_r_address0,
...
localparam
    ...
    ADDR_INPUT_R_BASE = 14'h2000,
    ADDR_INPUT_R_HIGH = 14'h3fff,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
assign int_input_r_address1 = ar_hs? raddr[12:2] : waddr[12:2];
...
module runner_control_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
