...
entity runner_mask_table_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of runner_mask_table_rom is 
...
architecture arch of runner_mask_table is
    component runner_mask_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    runner_mask_table_rom_U :  component runner_mask_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
